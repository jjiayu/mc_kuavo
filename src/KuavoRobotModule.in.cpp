...
KuavoRobotModule::KuavoRobotModule() : mc_rbdyn::RobotModule(JVRC_DESCRIPTION_PATH, "jvrc1")
{
...
ROBOT_MODULE_DEFAULT_CONSTRUCTOR("KuavoRobotModule", mc_robots::KuavoRobotModule)
